    ...
    <form action="" method="POST" onsubmit="save();return false;">
      ...
      if ($file) {
        ...
        while ($line = @fgets($file))
          $alltext .= $line;
        if ($alltext == "") echo "// ここに論文の内容をMarkDown形式で書き込んで下さい";
